   ...
   <div class="p-5 mb-4 bg-body-tertiary rounded-3">
      <div class="container-fluid py-5">
		...
		<div class=" py-5">
			...
			%>
			<tr>
				<td class="text-center"><em><%=drink.getDrinkName()%> </em></td>
				<td class="text-center"><%=drink.getDrinkQuantity()%></td>
				<td class="text-center"><%=drink.getDrinkPrice()%>원</td>
